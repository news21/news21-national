...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.last_name'
        db.alter_column('core_profile', 'last_name', models.CharField(default='Doe', max_length=75))
        
        # Changing field 'Profile.first_name'
        db.alter_column('core_profile', 'first_name', models.CharField(default='John/Jane', max_length=75))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Profile.last_name'
        db.alter_column('core_profile', 'last_name', models.CharField(max_length=75))
        
        # Changing field 'Profile.first_name'
        db.alter_column('core_profile', 'first_name', models.CharField(max_length=75))
    ...
    models = {
        'core.profile': {
            ...
            'first_name': ('models.CharField', [], {'default': "'John/Jane'", 'max_length': '75'}),
            'gender': ('models.CharField', [], {'default': 'False', 'max_length': '10'}),
            'hometown': ('models.CharField', [], {'max_length': '100'}),
            'id': ('models.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('models.BooleanField', [], {'default': 'False'}),
            'last_name': ('models.CharField', [], {'default': "'Doe'", 'max_length': '75'}),
