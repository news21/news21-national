...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.expected_grad_date'
        db.add_column('core_profile', 'expected_grad_date', models.DateTimeField())
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Profile.expected_grad_date'
        db.delete_column('core_profile', 'expected_grad_date')
