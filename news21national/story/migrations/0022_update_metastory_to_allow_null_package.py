...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MetaStory.project'
        db.alter_column('story_metastory', 'project_id', models.ForeignKey(orm['story.Project'], null=True, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'MetaStory.project'
        db.alter_column('story_metastory', 'project_id', models.ForeignKey(orm['story.Project'], null=True))
