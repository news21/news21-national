...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MetaStory.primary_image'
        db.alter_column('story_metastory', 'primary_image', models.IntegerField(null=True, blank=True))
        
        # Changing field 'MetaStory.secondary_image'
        db.alter_column('story_metastory', 'secondary_image', models.IntegerField(null=True, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'MetaStory.primary_image'
        db.alter_column('story_metastory', 'primary_image', models.IntegerField(null=True))
        
        # Changing field 'MetaStory.secondary_image'
        db.alter_column('story_metastory', 'secondary_image', models.IntegerField(null=True))
