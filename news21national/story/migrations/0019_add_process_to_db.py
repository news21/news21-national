...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MetaStory.process'
        db.add_column('story_metastory', 'process', models.TextField(null=True, blank=True))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'MetaStory.process'
        db.delete_column('story_metastory', 'process')
