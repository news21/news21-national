...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MetaStory.sub_headline'
        db.alter_column('story_metastory', 'sub_headline', models.CharField(max_length=200, null=True, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'MetaStory.sub_headline'
        db.alter_column('story_metastory', 'sub_headline', models.CharField(max_length=200))
