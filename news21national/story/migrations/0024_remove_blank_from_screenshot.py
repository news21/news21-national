...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.screenshot'
        db.alter_column('story_project', 'screenshot', models.ImageField(_('image'), null=True, max_length=255))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Project.screenshot'
        db.alter_column('story_project', 'screenshot', models.ImageField(_('image'), max_length=255, null=True, blank=True))
