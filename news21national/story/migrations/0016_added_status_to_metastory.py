...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MetaStory.status'
        db.add_column('story_metastory', 'status', models.CharField(default='Pending Approval', max_length=50))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'MetaStory.status'
        db.delete_column('story_metastory', 'status')
