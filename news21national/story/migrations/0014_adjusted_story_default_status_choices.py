...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.alter_column('story_story', 'status', models.CharField(default='Pending Approval', max_length=50))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Story.status'
        db.alter_column('story_story', 'status', models.CharField(max_length=50))
