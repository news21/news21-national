...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('story', ['Project'])
        
        # Adding field 'MetaStory.project'
        db.add_column('story_metastory', 'project', models.ForeignKey(orm.Project, null=True))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('story_project')
        
        # Deleting field 'MetaStory.project'
        db.delete_column('story_metastory', 'project_id')
    ...
    models = {
        ...
        'story.metastory': {
            ...
            'project': ('models.ForeignKey', ["orm['story.Project']"], {'null': 'True'}),
