...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Story.location'
        db.delete_column('story_story', 'location')
        
        # Changing field 'Story.original_url'
        db.alter_column('story_story', 'original_url', models.URLField(blank=True, null=True, verify_exists=False))
        
    
    
    def backwards(self, orm):
        
        # Adding field 'Story.location'
        db.add_column('story_story', 'location', models.CharField(max_length=150))
        
        # Changing field 'Story.original_url'
        db.alter_column('story_story', 'original_url', models.URLField(verify_exists=False))
