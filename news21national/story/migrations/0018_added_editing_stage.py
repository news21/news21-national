...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MetaStory.stage'
        db.add_column('story_metastory', 'stage', models.CharField(default='', max_length=50, null=True, blank=True))
        
        # Adding field 'Story.stage'
        db.add_column('story_story', 'stage', models.CharField(default='', max_length=50, null=True, blank=True))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'MetaStory.stage'
        db.delete_column('story_metastory', 'stage')
        
        # Deleting field 'Story.stage'
        db.delete_column('story_story', 'stage')
