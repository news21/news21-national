...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Story.primary_image'
        db.alter_column('story_story', 'primary_image', models.IntegerField(null=True, blank=True))
        
        # Changing field 'Story.secondary_image'
        db.alter_column('story_story', 'secondary_image', models.IntegerField(null=True, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Story.primary_image'
        db.alter_column('story_story', 'primary_image', models.IntegerField(null=True))
        
        # Changing field 'Story.secondary_image'
        db.alter_column('story_story', 'secondary_image', models.IntegerField(null=True))
