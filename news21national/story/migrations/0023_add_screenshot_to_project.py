...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('story_project', 'screenshot', models.ImageField(_('image'), null=True, max_length=255, blank=True))
    ...
    def backwards(self, orm):
        ...
        db.delete_column('story_project', 'screenshot')
    ...
    models = {
        'story.project': {
            ...
            'screenshot': ('models.ImageField', ["_('image')"], {'null': 'True', 'max_length': '255', 'blank': 'True'}),
