...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Payload.placed_at'
        db.alter_column('socialchecklist_payload', 'placed_at', models.DateTimeField(null=True, editable=False, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Payload.placed_at'
        db.alter_column('socialchecklist_payload', 'placed_at', models.DateTimeField(editable=False))
